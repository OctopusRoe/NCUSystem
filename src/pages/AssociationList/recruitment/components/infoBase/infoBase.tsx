...
class InfoBase extends Component<SettingsProps, SettingsState> {
  ...
  constructor(props: SettingsProps) {
    ...
    const menuMap = {
      baseInfo: (
        <FormattedMessage id="info.menuMap.setting" defaultMessage="BaseInfo Info" />
      ),
      organization: (
        <FormattedMessage id="info.menuMap.management" defaultMessage="Organization Info" />
      ),
      position: (
        <FormattedMessage id="info.menuMap.statistical" defaultMessage="Position Info" />
      ),
    };
    this.state = {
      mode: 'inline',
  ...
  renderChildren = () => {
    ...
    switch (selectKey) {
      case 'baseInfo':
        return <Setting formInfo={formInfo} />;
      case 'organization':
        return <Management />;
      case 'position':
        return <Statistical />;
