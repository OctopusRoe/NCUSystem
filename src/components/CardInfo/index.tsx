...
import FormatGrid from './formartgrid/index';
...
const data = [
  [
    { title: '社团类别', value: '测试类别1' },
    { title: '成立时间', value: '2010-01-01' },
    {
      title: '社团章程',
      value: (
        <Tag onClick={clickMe} color={'blue'} style={changeMouseStyle}>
          在线查看
        </Tag>
      ),
    },
  ...
  [
    { title: '社团级别', value: '测试级别1' },
    { title: '学生负责人', value: '测试人员' },
    { title: '招新QQ群', value: '6655778899', copy: true },
  ],
  [
    { title: '指导单位', value: '信息工程学院' },
    { title: '指导老师', value: '测试人员' },
  ],
];
...
const CardInfo: React.FC<CardInfoProps> = (props) => {
  ...
  return (
    ...
    >
      <Row>
        <Col span={4}>
          <Row justify={'center'} align={'middle'} style={{ height: '115px', overflow: 'hidden' }}>
            <img
              src={'http://www.ncu.edu.cn/img/nculogo.jpg'}
              style={{ height: '115px', width: '115px', borderRadius: '50%' }}
              onClick={showImage}
            />
            <Image
              src={'http://www.ncu.edu.cn/img/nculogo.jpg'}
              style={{ display: 'none' }}
              id={'square-card-info-image'}
            />
          </Row>
        </Col>
        <Col span={20}>
      ...
      <Divider dashed style={{ fontSize: '14px', color: '#D2D2D2' }}>
        <ClockCircleOutlined /> 报名截止时间：{new Date().toLocaleDateString()}
      </Divider>
      <Row>
        <Col span={24}>
          <Table<any>
